...
public class VentanaPrin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Reportes.setBackground(new java.awt.Color(51, 51, 255));
        Reportes.setFont(new java.awt.Font("Silom", 0, 14)); // NOI18N
        Reportes.setForeground(new java.awt.Color(255, 255, 255));
        Reportes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/user_icon_150670.png"))); // NOI18N
        ...
        ClasesGrupales.setBackground(new java.awt.Color(51, 51, 255));
        ClasesGrupales.setFont(new java.awt.Font("Silom", 0, 14)); // NOI18N
        ClasesGrupales.setForeground(new java.awt.Color(255, 255, 255));
        ClasesGrupales.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/ejercicioico.jpg"))); // NOI18N
        ClasesGrupales.setText("Clases Grupales");
        ClasesGrupales.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 10, 1, 1, new java.awt.Color(0, 0, 0)));
        ClasesGrupales.setBorderPainted(false);
        ClasesGrupales.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ClasesGrupales.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ClasesGrupales.setIconTextGap(10);
        ClasesGrupales.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ClasesGrupalesActionPerformed(evt);
            }
        });
        ...
        Rutina.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/rutina-diaria (2).png"))); // NOI18N
        ...
        MenuLayout.setHorizontalGroup(
            ...
            .addComponent(Rutina, javax.swing.GroupLayout.PREFERRED_SIZE, 270, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private javax.swing.JButton ClasesGrupales;
